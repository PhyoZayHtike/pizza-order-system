                ...
                <table class="table table-light table-borderless table-hover text-center mb-0" id="dataTable">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><img class="img-thumbnail shadow-sm" src="{{asset('storage/'.$c->product_image)}}" alt="" style="width: 100px;"></td>
                            ...
                            <td class="align-middle"><button id="" class="btn btn-sm btn-danger btnRemove"><i class="fa fa-times"></i></button></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button id="orderBtn" class="btn btn-block btn-primary rounded-3 font-weight-bold my-3 py-3">Proceed To Checkout</button>
                        <button id="clearBtn" class="btn btn-block btn-danger rounded-3 font-weight-bold my-3 py-3">Clear Cart</button>
                    </div>
                </div>
            </div>
        </div>
